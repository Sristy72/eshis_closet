...
class LongKurti extends StatefulWidget {
  const LongKurti({super.key, required this.category});
  final Category category;

  @override
  State<LongKurti> createState() => _LongKurtiState();
}

class _LongKurtiState extends State<LongKurti> {
